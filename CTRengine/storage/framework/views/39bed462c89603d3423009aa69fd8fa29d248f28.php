<?php $__env->startSection('content'); ?>
    ...
    <script src="<?php echo e(asset('./assets/js/amcharts.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('./assets/js/jquery-3.1.1.js')); ?>"></script>
    <script src="<?php echo e(asset('./assets/js/bootstrap.js')); ?>"></script>
    <script src="<?php echo e(asset('./assets/js/dataloader.js')); ?>"></script>
    <link href="https://gitcdn.github.io/bootstrap-toggle/2.2.2/css/bootstrap-toggle.min.css" rel="stylesheet">
    <script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>

    <link rel="stylesheet" href="<?php echo e(asset('./css/style.css')); ?>" type="text/css" media="all">
    <link rel="stylesheet" href="<?php echo e(asset('./css/cryptocoins.css')); ?>" type="text/css" media="all">
                    ...
                    <div class="limit_order">
                        ...
                        <div class="advanced_section">
                            <div class="header">
                                ...
                                <a href="https://support.gdax.com/customer/portal/articles/2426596" target="_blank" rel="noopener noreferrer">Help</a>
                            </div>
                            <div class="advanced_content">
                                ...
                                <div class="section">
                                    <label><input type="checkbox" value="on"> Post Only</label>
                                </div>
                            </div>
                        </div>
                        <div class="note">Post Only is not selected, this order may execute as a taker order.
                        </div> 
                        <div class="order_total">
                        <div>
                            <b>Total</b>
