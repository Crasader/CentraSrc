<?php $__env->startSection('content'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('./css/pickmeup.css')); ?>">
    <link rel="stylesheet" media="screen" href="<?php echo e(asset('./css/calendar.css')); ?>">
    <script src="<?php echo e(asset('./js/pickmeup.js')); ?>"></script>
    ...
    <div class="banner">
        <div class="row section" style="padding: 4px 20px;">
            <div class="logo"><img src="<?php echo e(asset('images/centra logo.png')); ?>"/></div>
        ...
        <?php if(!Auth::guest()): ?>
            <div id="banner_login" style="float:right;">
                    <div id="user">
                         <div id="username"><?php echo e(Auth::user()->name); ?></div>
                         <div class="caret"></div>
                    </div>
